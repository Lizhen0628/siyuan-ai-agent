...
界面语言自动跟随思源的界面语言设置（设置 → 外观 → 语言）：中文界面显示中文，其余语言显示英文（含面板、设置、工具能力与内置技能文案）。
...
- **能力体系**：45+ 项笔记能力（笔记本/文档/块/数据库(属性视图)/标签/书签/属性/资源/日记/快照/SQL + 打开文档/定位块/打开搜索/打开设置），能力页逐项开关、搜索、读/写/前端徽章；写能力支持 跟随全局/每次确认/自动批准 分级
